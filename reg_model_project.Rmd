...
```
Essentially, this means that a movie will score around 6.5 on IMDB. This is helpful for us to bear in mind when it comes to our later modelling.
...
There is some concern that the residuals do dip at the beginning in the scatter plot. However, we do not set a fan shape or anything which indicates an underlying relationship between the variables.
